...
class CustomerCreditCard extends MoipResource
{
    ...
    /**
     * Data de nascimento do aluno. date(AAAA-MM-DD),.
     *
     * @param $birthdate
     *
     * @return $this
     ...
     * @param int $area_code    Código de área do aluno. Limite de caracteres: (2).
     * @param int $number       Número de telefone do aluno. Limite de caracteres: 9
     *
     * @return $this
     */
