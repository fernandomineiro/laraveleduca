...
Nesse exemplo será criado um pedido com dados do aluno - Com endereço de entrega e de pagamento.
```php
...
Para realizar o pagamento, via cartão de crédito, utilizando o cartão de um terceiro (quando o aluno não é o portador do cartão que será utilizado), é necessário que estes dados sejam diferenciados e informados corretamente, para cada etapa do fluxo.
