...
class CupomImportarController extends Controller{
    ...
    public function salvar(Request $request){
        ...
        try {
            ...
            Excel::import(new CupomImport(),$request->file('arquivo_excel'));
        ...
        return redirect()->route('admin.cupom');
