                        ...
                        @foreach($objLst as $obj)
                            <tr>
                                ...
                                <td style="text-align: center">
                                    @if($obj->usuario_ativo == 1)
                                        <a href="{{ $obj->curador_id }}/editar"
                                           class="btn btn-default btn-sm"><i class="fa fa-fw fa-edit"></i></a>
                                        {{ Form::open(['method' => 'DELETE', 'route' => ['admin.curador.deletar', $obj->curador_id], 'style' => 'display:inline;']) }}
