...
<div class="container" style="padding:0;">
  ...
  <div class="centered">
      <div>{{$faculdadeFantasia}} certifica que <b style="font-size: 32px;line-height: 32px;">{{ $usuario['nome'].' '.$usuario['sobre_nome'] }}</b>
      concluiu os cursos sobre {{ $estrutura->titulo }}, em {{ $data }}.</div>
  </div>
