...
@section('content')
	<div class="box padding20">
		<div class="row">
			<div class="col-md-9"><h2 class="table">Tempo Médio de Navegação</h2></div>
...
@push('js')
	...
	<script type="text/javascript">
    	...
    	function drawTempoMedioNavegacao() {
			...
			data.addColumn('string', 'Página');
			data.addColumn('number', 'Segundos');

			data.addRows([
				@foreach($grafico_tempo_medio_navegacao as $dado)
					['{{ $dado[0] }}', {{ $dado[1] }}],
				@endforeach
			]);
