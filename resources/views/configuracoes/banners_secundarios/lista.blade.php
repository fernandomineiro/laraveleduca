...
@section('content')
    <div class="box padding20">
        <div class="col-md-9"><h2 class="table">Configurações Banners Secundários</h2></div>
        <div class="col-md-3" style="margin-top: 20px;">
            <a href="{{ route('admin.banner_secundario.incluir') }}"
        ...
        @if(count($objlista) > 0)
            <table class="table table-bordered table-striped dataTable">
                ...
                @foreach($objlista as $obj)
                    <tr>
                        <td>{{ $obj->faculdade->razao_social }}</td>
                        <td>{{ $obj->titulo }}</td>
                        <td>
