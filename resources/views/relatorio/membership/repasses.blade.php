...
@section('content')
	<div class="box padding20">
		<div class="col-md-9">
            <h2 class="table">Membership - Relatório de repasses</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-2 col-lg-2">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('group_by', $grupos, (request()->get('group_by') ? request()->get('group_by') : 0 ), ['class' => 'form-control', 'id' => 'group_by']) }}
                                    </div>
                                </div>
