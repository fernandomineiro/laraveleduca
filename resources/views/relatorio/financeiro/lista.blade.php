...
@section('content')
	<div class="box padding20">
		<div class="col-md-9"><h2 class="table">Relatório Financeiro</h2></div>
						...
						<form role="form" method="get" enctype="application/x-www-form-urlencoded">
							...
							<div class="col-xs-6 col-md-3 col-lg-3">
								<div class="form-group">
									...
									<input type="text" name="data_compra" id="data_compra" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%" />
								</div>
							</div>
