...
@section('content')
	<div class="box padding20">
		...
		<div class="col-md-3" style="margin-top: 20px;">
			<form method="POST" action="{{ url('/admin/relatorio_status_assinatura/salvar') }}" id="form-export-to" class="pull-right" style="float: right;">
		...
		<br>
    		@if(count($relatorio_status_assinatura) > 0)
                <div class="box">
                    ...
                    <div class="box-body" id="divDados">
                        <table class="table table-bordered table-striped dataTable">
                            ...
                            <tbody>
                            @foreach($relatorio_status_assinatura as $dado)
                                <tr>
                                    <td>{{ $dado->aluno }}</td>
                                    <td>{{ $dado->rg }}</td>
                                    <td>{{ $dado->ies }}</td>
