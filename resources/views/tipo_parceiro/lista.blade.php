            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped dataTable">
                        ...
                        <tbody>
                        @foreach($tipo_parceiro as $tipoParceiro)
                            <tr>
                                <td>{{ $tipoParceiro->descricao }}</td>
                                <td>{{ $lista_status[$tipoParceiro->status] }}</td>
                                <td style="text-align: center">
                                    <a href="{{ $tipoParceiro->id }}/editar"
                                       class="btn btn-default btn-sm" title="Editar"><i
                                            class="fa fa-fw fa-edit"></i></a>
                                    {{ Form::open(['method' => 'DELETE', 'route' => ['admin.'.$modulo['moduloDetalhes']->rota.'.deletar', $tipoParceiro->id], 'style' => 'display:inline;']) }}
